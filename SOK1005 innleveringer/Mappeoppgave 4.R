...
#prøvde mitt beste med map og function til å få det til men fikk bare en haug med
#Error som: Index 1 must have length 1, not 6 eller Error in test[1, ] : incorrect number of dimensions
#så endte med veldig lite effektivt start på den
